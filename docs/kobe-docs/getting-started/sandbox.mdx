...
Pools that use `zondax/kobe-agent-workspace-gui` can start a noVNC desktop (Firefox, Openbox, Tauri prerequisites). Walkthrough: [Desktop](/docs/getting-started/desktop).
