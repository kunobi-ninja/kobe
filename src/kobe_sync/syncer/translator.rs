...
pub const LABEL_MANAGED: &str = "kobe-sync.kunobi.ninja/managed";
/// Label key carrying the virtual namespace of a managed resource.
pub const LABEL_VNS: &str = "kobe-sync.kunobi.ninja/vns";
/// Annotation key recording the translation scheme version.
pub const ANNOTATION_SCHEME_VERSION: &str = "kobe-sync.kunobi.ninja/scheme-version";
