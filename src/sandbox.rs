...
/// Why a Sandbox lease holds its capacity instead of releasing it.
///
/// A closed vocabulary. The value becomes the `CleanupVerified` condition
/// reason and a log field, so it stays bounded and stable; each wire name is
/// the variant in snake_case.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum QuarantineReason {
    AbsenceUnverifiable,
    AccessDrainForbidden,
    AccessDrainUnverifiable,
    AccessGateForbidden,
    AccessGateUnverifiable,
    AdmissionOnlyProvenanceInvalid,
    AllocationFenceIdentityChanged,
    AllocationFenceMissing,
    AllocationFenceProvenanceInvalid,
    AllocationFenceTimestampMissing,
    AllocationFenceUidMissing,
    AllocationFenceUnverifiable,
    BoundExecutionMissing,
    ChildAbsenceUnverifiable,
    ChildApiAuthenticationFailed,
    ChildApiResponseUnverifiable,
    ChildBindingIdentityUnverifiable,
    ChildBindingProvenanceChanged,
    ChildCompositionGenerationChanged,
    ChildCompositionGenerationMissing,
    ChildCompositionIdentityChanged,
    ChildCompositionIdentityUnverifiable,
    ChildCompositionProvenanceInvalid,
    ChildCompositionProvenanceMissing,
    ChildCompositionUidMissing,
    ChildCompositionUnverifiable,
    ChildCredentialCleanupUnverifiable,
    ChildCredentialTargetUnverifiable,
    ChildKubeconfigClientInvalid,
    ChildKubeconfigPayloadInvalid,
    ChildKubeconfigProtocolMissing,
    ChildKubeconfigProvenanceMissing,
    ChildKubeconfigSecretForbidden,
    ChildKubeconfigSecretMalformed,
    ChildKubeconfigSecretMissing,
    ChildKubeconfigSecretReplaced,
    ChildNamespaceIdentityChanged,
    ChildNamespaceUnverifiable,
    ChildParentUidMissing,
    ChildPoolIdentityChanged,
    ChildPoolProvenanceInvalid,
    ChildPoolProvenanceUnavailable,
    ChildPoolProvenanceUnverifiable,
    ChildPrecheckpointStateUnverifiable,
    ChildReceiptAcknowledgementChanged,
    ChildReceiptAuthorityUnavailable,
    ChildReceiptAuthorityUnverified,
    ChildReceiptDoesNotMatch,
    ChildReceiptDoesNotMatchPrecheckpoint,
    ChildReceiptUnavailable,
    ChildTargetNamespaceChanged,
    ChildTargetProvenanceMissing,
    ChildTeardownModeChanged,
    ChildTeardownModeMissing,
    ChildTeardownQuarantined,
    ChildUnboundProofCheckpointChanged,
    ClaimAbsenceUnverifiable,
    ClaimIdentityUnverifiable,
    ClaimLabelledSandboxReplaced,
    ClaimLabelledSandboxUnrecorded,
    ClaimNamespaceChanged,
    ClaimOwnerrefLegacyUnverifiable,
    ClaimProvenanceInvalid,
    ClaimProvenanceMissing,
    ClaimProvenanceMissingAfterAbsence,
    ClaimTombstoneDeletingWithoutCleanupFence,
    ClaimTombstoneIdentityChanged,
    ClaimTombstoneIdentityUnverifiable,
    ClaimTombstoneMissing,
    ClaimTombstoneProvenanceInvalid,
    ClaimTombstoneUnverifiable,
    CredentialCleanupUnverifiable,
    CredentialProvenanceInvalid,
    ExecutionClaimProvenanceMissing,
    ExecutionDeleteForbidden,
    ExecutionFinalizerUnverifiable,
    ExecutionIdentityUnverifiable,
    ExecutionLeaseStatusMissing,
    ExecutionListForbidden,
    ExecutionManifestMismatch,
    ExecutionManifestUnverifiable,
    ExecutionNameDuplicated,
    ExecutionNotInManifest,
    ExecutionParentUidMissing,
    ExecutionPlacementMissing,
    ExecutionPodProvenanceMissing,
    ExecutionReplacedDuringCleanup,
    ExecutionRunnerProvenanceChanged,
    ExecutionRunnerProvenanceMissing,
    ExecutionRvMissing,
    ExecutionSandboxProvenanceMissing,
    ExecutionStateUnverifiable,
    ExecutionTargetProvenanceMissing,
    ExecutionUidMissing,
    ManagementTargetNamespaceChanged,
    ManagementTargetProvenanceInvalid,
    ManagementTargetProvenanceMissing,
    NeverBoundExecutionManifestNonempty,
    PodAbsenceUnverifiable,
    PodEnumerationUnverifiable,
    PodIdentityChangedDuringTeardown,
    PodIdentityUnverifiable,
    PodOwnerChainUnverifiable,
    ...
    PvcEnumerationUnverifiable,
    ReleaseCauseMissing,
    RequiredServiceProvenanceMissing,
    SandboxAbsenceUnverifiable,
    SandboxEnumerationUnverifiable,
    SandboxIdentityChangedDuringTeardown,
    SandboxIdentityUnverifiable,
    SandboxOwnedPodReplaced,
    SandboxOwnedServiceReplaced,
    SandboxOwnerIdentityChanged,
    ServiceAbsenceUnverifiable,
    ServiceEnumerationUnverifiable,
    ServiceIdentityChangedDuringTeardown,
    ServiceIdentityUnverifiable,
    ServiceOwnerChainUnverifiable,
    ServiceOwnerIdentityChanged,
    ServiceProvenanceInvalid,
    ServiceRequirementPoolIdentityChanged,
    ServiceRequirementPoolMissing,
    ServiceRequirementUnverifiable,
    StaleUncertainty,
    UnexpectedPersistentStorage,
}

impl QuarantineReason {
    pub const fn as_str(self) -> &'static str {
        match self {
            Self::AbsenceUnverifiable => "absence_unverifiable",
            Self::AccessDrainForbidden => "access_drain_forbidden",
            Self::AccessDrainUnverifiable => "access_drain_unverifiable",
            Self::AccessGateForbidden => "access_gate_forbidden",
            Self::AccessGateUnverifiable => "access_gate_unverifiable",
            Self::AdmissionOnlyProvenanceInvalid => "admission_only_provenance_invalid",
            Self::AllocationFenceIdentityChanged => "allocation_fence_identity_changed",
            Self::AllocationFenceMissing => "allocation_fence_missing",
            Self::AllocationFenceProvenanceInvalid => "allocation_fence_provenance_invalid",
            Self::AllocationFenceTimestampMissing => "allocation_fence_timestamp_missing",
            Self::AllocationFenceUidMissing => "allocation_fence_uid_missing",
            Self::AllocationFenceUnverifiable => "allocation_fence_unverifiable",
            Self::BoundExecutionMissing => "bound_execution_missing",
            Self::ChildAbsenceUnverifiable => "child_absence_unverifiable",
            Self::ChildApiAuthenticationFailed => "child_api_authentication_failed",
            Self::ChildApiResponseUnverifiable => "child_api_response_unverifiable",
            Self::ChildBindingIdentityUnverifiable => "child_binding_identity_unverifiable",
            Self::ChildBindingProvenanceChanged => "child_binding_provenance_changed",
            Self::ChildCompositionGenerationChanged => "child_composition_generation_changed",
            Self::ChildCompositionGenerationMissing => "child_composition_generation_missing",
            Self::ChildCompositionIdentityChanged => "child_composition_identity_changed",
            Self::ChildCompositionIdentityUnverifiable => "child_composition_identity_unverifiable",
            Self::ChildCompositionProvenanceInvalid => "child_composition_provenance_invalid",
            Self::ChildCompositionProvenanceMissing => "child_composition_provenance_missing",
            Self::ChildCompositionUidMissing => "child_composition_uid_missing",
            Self::ChildCompositionUnverifiable => "child_composition_unverifiable",
            Self::ChildCredentialCleanupUnverifiable => "child_credential_cleanup_unverifiable",
            Self::ChildCredentialTargetUnverifiable => "child_credential_target_unverifiable",
            Self::ChildKubeconfigClientInvalid => "child_kubeconfig_client_invalid",
            Self::ChildKubeconfigPayloadInvalid => "child_kubeconfig_payload_invalid",
            Self::ChildKubeconfigProtocolMissing => "child_kubeconfig_protocol_missing",
            Self::ChildKubeconfigProvenanceMissing => "child_kubeconfig_provenance_missing",
            Self::ChildKubeconfigSecretForbidden => "child_kubeconfig_secret_forbidden",
            Self::ChildKubeconfigSecretMalformed => "child_kubeconfig_secret_malformed",
            Self::ChildKubeconfigSecretMissing => "child_kubeconfig_secret_missing",
            Self::ChildKubeconfigSecretReplaced => "child_kubeconfig_secret_replaced",
            Self::ChildNamespaceIdentityChanged => "child_namespace_identity_changed",
            Self::ChildNamespaceUnverifiable => "child_namespace_unverifiable",
            Self::ChildParentUidMissing => "child_parent_uid_missing",
            Self::ChildPoolIdentityChanged => "child_pool_identity_changed",
            Self::ChildPoolProvenanceInvalid => "child_pool_provenance_invalid",
            Self::ChildPoolProvenanceUnavailable => "child_pool_provenance_unavailable",
            Self::ChildPoolProvenanceUnverifiable => "child_pool_provenance_unverifiable",
            Self::ChildPrecheckpointStateUnverifiable => "child_precheckpoint_state_unverifiable",
            Self::ChildReceiptAcknowledgementChanged => "child_receipt_acknowledgement_changed",
            Self::ChildReceiptAuthorityUnavailable => "child_receipt_authority_unavailable",
            Self::ChildReceiptAuthorityUnverified => "child_receipt_authority_unverified",
            Self::ChildReceiptDoesNotMatch => "child_receipt_does_not_match",
            Self::ChildReceiptDoesNotMatchPrecheckpoint => {
                "child_receipt_does_not_match_precheckpoint"
            }
            Self::ChildReceiptUnavailable => "child_receipt_unavailable",
            Self::ChildTargetNamespaceChanged => "child_target_namespace_changed",
            Self::ChildTargetProvenanceMissing => "child_target_provenance_missing",
            Self::ChildTeardownModeChanged => "child_teardown_mode_changed",
            Self::ChildTeardownModeMissing => "child_teardown_mode_missing",
            Self::ChildTeardownQuarantined => "child_teardown_quarantined",
            Self::ChildUnboundProofCheckpointChanged => "child_unbound_proof_checkpoint_changed",
            Self::ClaimAbsenceUnverifiable => "claim_absence_unverifiable",
            Self::ClaimIdentityUnverifiable => "claim_identity_unverifiable",
            Self::ClaimLabelledSandboxReplaced => "claim_labelled_sandbox_replaced",
            Self::ClaimLabelledSandboxUnrecorded => "claim_labelled_sandbox_unrecorded",
            Self::ClaimNamespaceChanged => "claim_namespace_changed",
            Self::ClaimOwnerrefLegacyUnverifiable => "claim_ownerref_legacy_unverifiable",
            Self::ClaimProvenanceInvalid => "claim_provenance_invalid",
            Self::ClaimProvenanceMissing => "claim_provenance_missing",
            Self::ClaimProvenanceMissingAfterAbsence => "claim_provenance_missing_after_absence",
            Self::ClaimTombstoneDeletingWithoutCleanupFence => {
                "claim_tombstone_deleting_without_cleanup_fence"
            }
            Self::ClaimTombstoneIdentityChanged => "claim_tombstone_identity_changed",
            Self::ClaimTombstoneIdentityUnverifiable => "claim_tombstone_identity_unverifiable",
            Self::ClaimTombstoneMissing => "claim_tombstone_missing",
            Self::ClaimTombstoneProvenanceInvalid => "claim_tombstone_provenance_invalid",
            Self::ClaimTombstoneUnverifiable => "claim_tombstone_unverifiable",
            Self::CredentialCleanupUnverifiable => "credential_cleanup_unverifiable",
            Self::CredentialProvenanceInvalid => "credential_provenance_invalid",
            Self::ExecutionClaimProvenanceMissing => "execution_claim_provenance_missing",
            Self::ExecutionDeleteForbidden => "execution_delete_forbidden",
            Self::ExecutionFinalizerUnverifiable => "execution_finalizer_unverifiable",
            Self::ExecutionIdentityUnverifiable => "execution_identity_unverifiable",
            Self::ExecutionLeaseStatusMissing => "execution_lease_status_missing",
            Self::ExecutionListForbidden => "execution_list_forbidden",
            Self::ExecutionManifestMismatch => "execution_manifest_mismatch",
            Self::ExecutionManifestUnverifiable => "execution_manifest_unverifiable",
            Self::ExecutionNameDuplicated => "execution_name_duplicated",
            Self::ExecutionNotInManifest => "execution_not_in_manifest",
            Self::ExecutionParentUidMissing => "execution_parent_uid_missing",
            Self::ExecutionPlacementMissing => "execution_placement_missing",
            Self::ExecutionPodProvenanceMissing => "execution_pod_provenance_missing",
            Self::ExecutionReplacedDuringCleanup => "execution_replaced_during_cleanup",
            Self::ExecutionRunnerProvenanceChanged => "execution_runner_provenance_changed",
            Self::ExecutionRunnerProvenanceMissing => "execution_runner_provenance_missing",
            Self::ExecutionRvMissing => "execution_rv_missing",
            Self::ExecutionSandboxProvenanceMissing => "execution_sandbox_provenance_missing",
            Self::ExecutionStateUnverifiable => "execution_state_unverifiable",
            Self::ExecutionTargetProvenanceMissing => "execution_target_provenance_missing",
            Self::ExecutionUidMissing => "execution_uid_missing",
            Self::ManagementTargetNamespaceChanged => "management_target_namespace_changed",
            Self::ManagementTargetProvenanceInvalid => "management_target_provenance_invalid",
            Self::ManagementTargetProvenanceMissing => "management_target_provenance_missing",
            Self::NeverBoundExecutionManifestNonempty => "never_bound_execution_manifest_nonempty",
            Self::PodAbsenceUnverifiable => "pod_absence_unverifiable",
            Self::PodEnumerationUnverifiable => "pod_enumeration_unverifiable",
            Self::PodIdentityChangedDuringTeardown => "pod_identity_changed_during_teardown",
            Self::PodIdentityUnverifiable => "pod_identity_unverifiable",
            Self::PodOwnerChainUnverifiable => "pod_owner_chain_unverifiable",
            ...
            Self::PvcEnumerationUnverifiable => "pvc_enumeration_unverifiable",
            Self::ReleaseCauseMissing => "release_cause_missing",
            Self::RequiredServiceProvenanceMissing => "required_service_provenance_missing",
            Self::SandboxAbsenceUnverifiable => "sandbox_absence_unverifiable",
            Self::SandboxEnumerationUnverifiable => "sandbox_enumeration_unverifiable",
            Self::SandboxIdentityChangedDuringTeardown => {
                "sandbox_identity_changed_during_teardown"
            }
            Self::SandboxIdentityUnverifiable => "sandbox_identity_unverifiable",
            Self::SandboxOwnedPodReplaced => "sandbox_owned_pod_replaced",
            Self::SandboxOwnedServiceReplaced => "sandbox_owned_service_replaced",
            Self::SandboxOwnerIdentityChanged => "sandbox_owner_identity_changed",
            Self::ServiceAbsenceUnverifiable => "service_absence_unverifiable",
            Self::ServiceEnumerationUnverifiable => "service_enumeration_unverifiable",
            Self::ServiceIdentityChangedDuringTeardown => {
                "service_identity_changed_during_teardown"
            }
            Self::ServiceIdentityUnverifiable => "service_identity_unverifiable",
            Self::ServiceOwnerChainUnverifiable => "service_owner_chain_unverifiable",
            Self::ServiceOwnerIdentityChanged => "service_owner_identity_changed",
            Self::ServiceProvenanceInvalid => "service_provenance_invalid",
            Self::ServiceRequirementPoolIdentityChanged => {
                "service_requirement_pool_identity_changed"
            }
            Self::ServiceRequirementPoolMissing => "service_requirement_pool_missing",
            Self::ServiceRequirementUnverifiable => "service_requirement_unverifiable",
            Self::StaleUncertainty => "stale_uncertainty",
            Self::UnexpectedPersistentStorage => "unexpected_persistent_storage",
        }
    }
}
